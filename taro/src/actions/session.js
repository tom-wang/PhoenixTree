import { SET_CODE, SET_USERINFO, SET_REGINFO, SET_USERINFOLIST, SET_HASREG, SET_REGINFOLOADING, SET_USERINFOLOADING, SET_INDEXNEEDRELOAD } from '../constants/session'
...
export function setIndexNeedReload(val) {
    return {
        type: SET_INDEXNEEDRELOAD,
        payload: val
    }
}
